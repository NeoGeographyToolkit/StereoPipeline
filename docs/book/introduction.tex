...
Although no peer-reviewed paper or report yet exists which details
the Ames Stereo Pipeline (see the warning below about this being
BETA software), if you do use this software in your work, we'd
