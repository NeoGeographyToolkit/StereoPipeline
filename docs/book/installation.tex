...
the \texttt{ISISDATA} environment variable. This is normally
...
\end{verbatim} % $ A hidden dollar to not confuse emacs syntax highlighting. 

You need to set up your ISIS environment or manually set the correct
location for \texttt{ISISDATA}.
