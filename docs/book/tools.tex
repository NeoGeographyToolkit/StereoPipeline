...
optionally erodes pixels at the boundaries, and creates a mosaic,
blending the DEMs wherey they overlap.

Output prefix. All tiles will be output-prefix-tile-<num>.tif. If,
for example, the output prefix is results/output, all the tiles will be
