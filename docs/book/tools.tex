...
the THEIA software library (http://www.theia-sfm.org/index.html) for computing the relative
...
These are camera models in the local coordinate system and they are plain text files for easy inspection.
...
to pass to the bundle\_adjust tool.\\ \hline
\texttt{-\/-theia-flagfile  \textit{string}} & Path to a custom Theia flagfile to use settings from.\\ \hline
