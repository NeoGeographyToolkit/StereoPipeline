...
displacement, which can be used to seed the tool in a subsequent run.
...
defined as the closest distances between transformed source points and
reference points. The complete lists of errors are also saved to disk.
