...
centroid of the transformed source points. This translation component is
displayed in three ways (a) Cartesian coordinates with the origin at the
...
point used in alignment to the closest reference point. It displays the
16th, 50th, and 84th error percentiles, as well as the means of the
smallest 25\%, 50\%, 75\%, and 100\% of the errors, all these before and
the after alignment transform is applied to the source points.
