...
available in the \texttt{stereo-gui} tool.  

Alternately, you can use a set of estimated camera positions
(perhaps from a GPS unit) to register the camera models in world coordinates.
...
the example line below.  You may want to use the \texttt{-\/-camera-weight} option
to prevent the camera models from shifting too far from their starting positions.
