...
\texttt{-\/-num-erode-cloud-pixels \textit{int(=0)}} & Erode this many pixels around no-data values from the input point clouds before creating the DEM (after outliers are removed). \\ \hline
