...
The program \texttt{dem\_mosaic} takes as input a list of DEM files, optionally erodes pixels at the boundaries, and creates a mosaic, smoothly blending the DEMs wherey they overlap.

The tool can reproject the DEMs during mosacking, with the projection specified using the 
