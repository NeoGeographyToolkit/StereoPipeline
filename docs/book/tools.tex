...
The \texttt{-t} option also takes \texttt{\textit{obj}} and will
create a Wavefront OBJ format file (\texttt{\textit{output-prefix.obj}})
that represents the 3D geometry for use in various 3D graphics
programs.
