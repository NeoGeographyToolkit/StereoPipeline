...
points are used). Options: WGS\_1984, D\_MOON (radius = 1,737,400 meters), and D\_MARS
...
Crop the images this far from the current tile (in pixels) before blending them (a small value may result in artifacts).
\\ \hline
