...
location, before and after the alignment of source points, where an
error is defined as the distance from a source point used in alignment
to the closest reference point. It displays the 16th, 50th, and 84th
error percentiles, as well as the means of the smallest 25\%, 50\%,
