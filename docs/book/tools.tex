...
This tool can use several algoriths for bundle adjustment, the default is
...
\texttt{-\/-bundle-adjuster \textit{arg [default: Ceres]}} & Choose a solver from:
Ceres, RobustSparse, RobustRef, Sparse, Ref. \\ \hline

\texttt{-\/-cost-function \textit{arg [default: Cauchy]}} & Choose a cost function
...
points are used). [WGS\_1984, D\_MOON (radius is assumed to be 1737400 meters), D\_MARS 
(radius is assumed to be 33916190 meters), etc.] \\ \hline
...
in UTM coordinates (in meters), (d) Cartesian coordiates (x, y, z)
...
\texttt{-\/-datum \textit{string}} & Use this datum for CSV files. [WGS\_1984, D\_MOON (radius is assumed to be 1737400 meters), D\_MARS (radius is assumed to be 33916190 meters), etc.] \\ \hline
