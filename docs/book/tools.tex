...
This tool can be used to align two point clouds using Point-to-Plane Iterative
Closest Point (ICP) based on libpointmatcher
...
height above the datum (separated by commas or spaces), while for the
Moon one can use the LOLA RDR PointPerRow format. The tool is able to
auto-detect which of these formats is being used.
