...
Solves for intrinsic parameters and writes out pinhole file instead of adjust files. \\ \hline
\texttt{-\/-constant-intrinsics} & Used with the local pinhole option, holds the intrinsic parameters constant. \\ \hline
