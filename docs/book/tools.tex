...
\texttt{-\/-save-lon-lat-height-cloud-only \textit{[default: false]}} & Skip creating the DEM, just convert the cloud to longitude, latitude, height above datum, and save it.\\ \hline
