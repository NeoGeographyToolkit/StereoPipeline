...
The \verb#colormap# tool visualizes the data encoded in a DEM by reading in a DEM and writing a corresponding 
color-coded height image. 
...
\verb#--colormap-style arg# & Specify a file to describe the color output. 
It is similar to the file used by gdaldem. Alternately, use 'binary-red-blue' 
for a custom binary map. If not set the default jet colormap will be used. \\ \hline
