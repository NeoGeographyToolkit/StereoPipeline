...
translation. The transform assumes the 3D Cartesian coordinate system
with the origin at the planet center. This matrix can be supplied back
to the tool as an initial guess. The inverse transform is saved to a
file as well.
...
point used in alignment to the closest reference point. It displays the 16th, 50th, and
