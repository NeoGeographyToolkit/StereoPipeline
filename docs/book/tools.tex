...
\begin{verbatim}
mapproject -t rpc DEM.tif image.tif image.xml output-IMG.tif --mpp 20
\end{verbatim}

\begin{verbatim}
mapproject WGS84 image.tif output.tif --mpp 10
\end{verbatim}
...
\texttt{-\/-mpp} or \texttt{-\/-ppd}. Ideally it should be very close to the known image resolution
...
to use a unique file for each input image, pass a space seperated list of files surrounded by quotes.\\ \hline
