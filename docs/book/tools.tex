...
\texttt{-\/-initial-dem-constraint-weight \textit{double(=0.0)}} & A larger value will try harder to keep the SfS optimized DEM closer to the initial guess DEM.\\ \hline
