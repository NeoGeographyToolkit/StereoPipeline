...
The MAD cost mode can be used with any odd kernel size but the census cost modes 
can only be used with kernel sizes 3, 5, 7, and 9.  When using the MAD cost mode consider
