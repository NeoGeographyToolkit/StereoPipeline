...
Figure \ref{fig:corr-sgm-example} shows a comparision between two stereo modes. The DEM on the left was generated using the default stereo parameters and 
