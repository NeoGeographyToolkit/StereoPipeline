...
The correlation itself is carried out by sliding a small, rectangular
...
\centering
  ...
  \subfigure[{\tt Parabola Subpixel Mode}]{\includegraphics[width=2in]{images/correlation/3D_mode0.png}}
