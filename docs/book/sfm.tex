...
each of at least three GCP to show up in more than one image. Then its triangulated
position can be determined in local coordinates and in global (world) coordinates,
...
the longitude, latitude, and height of each of its four corners is known. Then,
