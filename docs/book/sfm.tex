\chapter{Camera Solve}
\label{ch:sfm}

The ASP tool \texttt{camera\_solve} offers several ways
to find the true position of pinhole camera images that do
...
below and described in more detail in the examples that folow:
\begin{itemize}{}
...
\href{http://apollo.sese.asu.edu/SUPPORT_DATA/AS15_SIMBAY_SUMMARY.pdf} 
...
ASP asol supports the method of initializing the \texttt{camera\_solve} tool with estimated
