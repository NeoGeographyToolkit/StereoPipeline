...
method is \texttt{none}, most outputs of stereo are georeferenced as
well, such as GoodPixelMap, D\_sub, filtered disparity, etc. As such,
all these data can be overlayed in
