...
The first says, \emph{`Don't do interest point alignment!'} since
...
be an offset? The reason for this is because \ac{ISIS} doesn't have a
perfect surface to project on to and that the camera position is
slightly off.
