...
imagery. Afterwards images can be mosaicked with \texttt{dg\_mosaic},
...
\texttt{dg\_mosaic} and map-projected. And jitter should be handled last,
during stereo.
...
intersection error map output by \texttt{point2dem -\/-errorimage}.
