...
from the free stereo pair labeled "System-Ready (1B) Stereo, 50cm" which
captures the city of Stockholm, found on
...
After you have downloaded the example stereo imagery of Stockholm, you
...
\begin{figure}[h!]
\centering
  \includegraphics[width=6.0in]{images/examples/dg/wv_tutorial_input.png}
  \includegraphics[width=6.0in]{images/examples/dg/wv_tutorial_colormap.png}
...
One should use the version of python installed with the above when running
stereo, hence the path should be set as:
...
In the multiview scenario, the first image is set as reference, disparities are
...
\pageref{point2mesh}). It can be viewed with
