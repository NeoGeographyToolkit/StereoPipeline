...
In addtion to Digital Globe's satelites, ASP supports any Earth imagery
...
parameters to improve the results. If the input images are
map-projected, the GoodPixelMap will also be georeferenced, so it can be
overlayed on top of the left input image in \texttt{stereo\_gui}.
...
provideds a tool named \texttt{image2qtree} for that purpose. It creates
