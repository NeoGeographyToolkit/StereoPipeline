...
Example of using \texttt{pc\_align} to align a DEM obtaind using stereo
...
Digital Globe provides imagery from the Quick Bird and the two World
...
only on procesing data using the linear camera model.  For more detail
