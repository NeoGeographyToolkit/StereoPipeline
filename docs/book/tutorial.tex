...
The string \texttt{stereo-output} is an arbitrary output prefix string, 
that is used when generating names for \texttt{stereo} output files. For
...
As mentioned in section \ref{quickstart}, the string
...
This command can also take multiple input images, performing
