...
Since each observation contains both stereo channels you only need one
to create a DEM!

HRSC data is organized into categories.  Level 2 is radiometrically corrected,
level 3 is corrected and map projected on to MOLA, and level 4 is corrected
...
of the already created DEMs it may be easiest to use the aeroid referenced version
(.da4 extension) since that is consistent with MOLA.

\subsection{Frame 1995}
...
\begin{verbatim}
  ...
  ISIS 3> stereo h1995_0000_s12.cub  h1995_0000_s22.cub --stereo-algorithm 2 --cost-mode 3 mgm/out
\end{verbatim}
