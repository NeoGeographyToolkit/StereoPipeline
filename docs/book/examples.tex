...
\ref{mapproj-example}. If the RPC coefficients are not stored in the orignal
Tif images, but rather in associated .RPB or \_RPC.TXT files, analogous
files must be created for each map-projected image. 
