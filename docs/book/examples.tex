...
binary file with no header information or a geotiff file.  
The header file is human readable XML but it is
fairly large.  When using SPOT5 images with ASP tools, pass in the data file
...
ASP has no ability to write images in SPOT5 format.
...
\begin{figure}[h!]
\centering
  \includegraphics[width=2.0in]{images/examples/spot5/GeoEye_ContextRender_400px.png}
  \includegraphics[width=2.0in]{images/examples/spot5/GeoEye_CloseUp_400px.png}
  \includegraphics[width=2.0in]{images/examples/spot5/GeoEye_CloseUpDRG_400px.png}
\caption{Example colorized height map and ortho image output.}
\label{fig:geoeye-nomap-example}
\end{figure}
