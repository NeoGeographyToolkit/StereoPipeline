...
can be obtained by first doing bundle-adjustment, then doing stereo as before
with bundle-adjusted images, followed by map-projection onto a coarser and smoother
...
\begin{verbatim}
  # Bundle adjustment
  bundle_adjust out-Band3N.tif out-Band3B.tif out-Band3N.xml out-Band3B.xml \
     -o out_ba/run -t rpc
  
  # Initial stereo with bundle-adjusted images
  stereo -t rpc --subpixel-mode 3 out-Band3N.tif out-Band3B.tif \
     out-Band3N.xml out-Band3B.xml out_stereo/run               \
     --bundle-adjust-prefix out_ba/run
  ...
  stereo --subpixel-mode 2 out-Band3N_proj.tif out-Band3B_proj.tif \
    out-Band3N.xml out-Band3B.xml out_stereo_proj/run              \
    out_stereo/run-300m-DEM.tif -t rpc --bundle-adjust-prefix out_ba/run
