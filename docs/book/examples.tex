...
in a pitch of
\begin{equation*}
  p = 70/10602 = 0.0066025
\end{equation*}

Since in this example the image resolution will be reduced by a factor of 8,
the pitch needs to be multiplied by this number, becoming 0.05282~mm.
...
\begin{verbatim}
  cam_gen --pixel-pitch 0.05282 --focal-length 609.602                       \
   --optical-center 398.844 35                                               \
