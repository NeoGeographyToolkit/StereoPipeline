...
This example uses data from the November 5, 2009 flight over Antarctica.  The following camera
model was used:
...
in this case to each image's immediate "neigbors".  (b) Display of \texttt{camera\_solve} 
...
The ASP DEM could be improved but the registration is accurate.}
