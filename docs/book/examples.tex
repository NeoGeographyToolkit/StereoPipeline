...
that we reuse the filtered match points created by stereo. 
\begin{verbatim}
  i=1
  ((j=i+1))
  st=stereo_v${i}${j}
...
In this case the mean error after alignemnt was about 6.5 m, 
...
If \texttt{pc\_align} was called with the refrence DEM being
