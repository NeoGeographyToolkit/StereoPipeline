...
DEM they produced has been moved to the correct location.

\begin{figure}[h!]
\centering
  \includegraphics[width=3.0in]{images/examples/pinhole/a15_image_diff.png}
\caption{The narrow LRONAC DEM overlaid on the larger pinhole DEM.  They are both 
color shaded over the same elevation range.}
