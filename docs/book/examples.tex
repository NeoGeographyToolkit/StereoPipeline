...
\subsubsection*{Merging LRONAC files}

The new lronac2mosaic.py tool allows you to merge a pair of LE/RE images into a single file and use that for stereo processing.

\begin{verbatim}
    ISIS 3> lronac2mosaic.py M104318871LE.img M104318871RE.img
    ISIS 3> lronac2mosaic.py M104311715LE.img M104311715RE.img   
    ISIS 3> stereo M104318871LE.lronaccal.lronacecho.noproj.mosaic.norm.cub M104311715LE.lronaccal.lronacecho.noproj.mosaic.norm.cub result/output
\end{verbatim}
