...
Wall Time & \texttt{+36:00:00.0} & CPU Time & \texttt{+36:00:00.0} \\
\multicolumn{3}{l}{ \emph{Processing in Stereo} } \\
Wall Time & \texttt{} & CPU Time & \texttt{} \\
\end{tabular}
...
\begin{verbatim}
  ...
  ISIS 3> cam2map from=PSP_001777_1650_RED.mos_hijitreged.norm.cub \
                    to=PSP_001777_1650_REDmosaic.norm.cub
  ISIS 3> cam2map from=PSP_001513_1655_RED.mos_hijitreged.norm.cub \
                   map=PSP_001777_1650_REDmosaic.norm.cub \
                    to=PSP_001513_1655_REDmosaic.map.cub matchmap=true
...
\begin{tabular}{ r c r c}
\multicolumn{3}{l}{ \emph{Prepping Files} } \\
Wall Time & \texttt{04:02:11.00} & CPU Time & \texttt{04:05:26.81} \\
\multicolumn{3}{l}{ \emph{Processing in Stereo} } \\
Wall Time & \texttt{59:51:01.00} & CPU Time & \texttt{164:55:02.36} \\
\end{tabular}
...
\begin{tabular}{ r c r c}
\multicolumn{3}{l}{ \emph{Prepping Files} } \\
Wall Time & \texttt{00:02:42.30} & CPU Time & \texttt{00:02:42.06} \\
\multicolumn{3}{l}{ \emph{Processing in Stereo} } \\
Wall Time & \texttt{01:22:17.00} & CPU Time & \texttt{03:14:45.78} \\
\end{tabular}
...
\begin{tabular}{ r c r c}
\multicolumn{3}{l}{ \emph{Prepping Files} } \\
Wall Time & \texttt{00:01:57.52} & CPU Time & \texttt{00:01:56.79} \\
\multicolumn{3}{l}{ \emph{Processing in Stereo} } \\
Wall Time & \texttt{01:44:34.00} & CPU Time & \texttt{04:12:25.11} \\
\end{tabular}
