...
model, so the geometric integrity of your images will not be sacrified
...
{\tt noproj} command into the perspective of RED5 CCD. From there,
...
% NOTE: LROC data has not been released, this section is inappropriate
% for the general public at this time, it'll just frustrate them, 
% although consider it a hidden Easter-egg for those that download the
% source--and read the LaTeX source!  Make sure to uncomment upon LROC public
% release.
% 
%
...
%     ISIS 3> cam2map from=nacl00002db8.cub to=nacl00002db8.map.cub
%     ISIS 3> cam2map from=nacl00004c86.cub map=nacl00002db8.map.cub ...
%     ISIS 3>         to=nacl00004c86.map.cub matchmap=true
%     ISIS 3> mkdir result
%     ISIS 3> stereo nacl00002db8.map.cub nacl00004c86.map.cub result/output
% \end{verbatim}
% 
% \subsubsection*{stereo.default}
% 
