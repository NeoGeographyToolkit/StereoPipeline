...
may differ by a large translation, which we correct here. (In principle 
we could have easily done the reverse transformation, briging the intial
SfS guess closer to the ``ground truth''.)
