...
resolution will even more exacerbate the errors in camera
positions and orientations. In that case running the tool at multiple levels
of resultion is helpful, as described in section \ref{sfs:insights}.
