...
\begin{center}
\fcolorbox{black}{lgray}{ \begin{minipage}{5.5in} Unfortunately in
    this Alpha 1.0.0 release, \texttt{isis\_adjust} is not in working
    order to process linescan imagers and is only working reliably
    only for frame cameras. This is of priority to get working again
...
%% \begin{verbatim}
%%         ipfind  m1000254.png r0901059.png -t 512
...
%%     \texttt{ipmatch}. Expect to find approximately ~40 matched
