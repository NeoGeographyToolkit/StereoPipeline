...
copy the transformed cameras from these runs and the dense interest
point files, and run bundle adjustment with intrinsics optimization
jointly for all cameras.
