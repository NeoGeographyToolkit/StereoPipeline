...
#define ASSOC_TO_DO(X,Y,V,D)           desc->add_options()(X, po::value<int>(&(todo->Y))->default_value(V), D); \
  ...
  ASSOC_INT("DO_H_SUBPIXEL", do_h_subpixel, 0, "Do vertical subpixel interpolation.")
  ASSOC_INT("DO_V_SUBPIXEL", do_v_subpixel, 0, "Do horizontal subpixel interpolation.")
