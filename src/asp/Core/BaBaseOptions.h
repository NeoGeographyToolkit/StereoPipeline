...
struct BaBaseOptions: public asp::OptimizerOptions {
  ...
  bool have_overlap_list, propagate_errors, match_first_to_last, single_threaded_cameras,
    ...
    save_cnet_as_gcp;
  double forced_triangulation_distance, max_triangulation_angle,
    max_init_reproj_error, reference_terrain_weight,
  ...
  BaBaseOptions(): asp::OptimizerOptions(),
