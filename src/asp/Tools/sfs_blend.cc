...
//     std::string out_file = "lit_mask.tif"; 
//     vw_out() << "Writing: " << out_file << "\n";
//     bool has_georef = false, has_nodata = false;
//     TerminalProgressCallback tpc("asp", ": ");
//     float sfs_nodata = -1.0;
//     int block_size = 256 + 2 * 100;
//     vw::cartography::GeoReference sfs_georef;
//     block_size = 16*ceil(block_size/16.0); // internal constraint
//     asp::save_with_temp_big_blocks(block_size,
//                                    out_file, 
//                                    vw::copy(vw::fill_holes_grass(mask, m_opt.min_blend_size)), 
//                                    has_georef, sfs_georef,
//                                    has_nodata, sfs_nodata, 
//                                    opt, tpc);
// }
// {
//     vw::GdalWriteOptions opt;
//     std::string out_file = "lit_grass.tif"; 
//     vw_out() << "Writing: " << out_file << "\n";
//     bool has_georef = false, has_nodata = false;
//     TerminalProgressCallback tpc("asp", ": ");
//     float sfs_nodata = -1.0;
...
// {
//     vw::GdalWriteOptions opt;
//     std::string out_file = "shadow_grass.tif"; 
//     vw_out() << "Writing: " << out_file << "\n";
//     bool has_georef = false, has_nodata = false;
//     TerminalProgressCallback tpc("asp", ": ");
//     float sfs_nodata = -1.0;
...
// {
//     vw::GdalWriteOptions opt;
//     std::string out_file = "dist_to_bd.tif";
//     vw_out() << "Writing: " << out_file << "\n";
//     bool has_georef = false, has_nodata = false;
//     TerminalProgressCallback tpc("asp", ": ");
//     float sfs_nodata = -1.0;
