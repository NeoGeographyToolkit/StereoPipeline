  ...
  void handle_arguments( int argc, char *argv[], ASPGlobalOptions& opt,
    ...
    general_options_sub.add_options()
      ("session-type,t",      po::value(&opt.stereo_session_string),
                              "Select the stereo session type to use for processing. [options: pinhole isis dg rpc spot5 aster opticalbar pinholemappinhole isismapisis dgmaprpc rpcmaprpc astermaprpc spot5maprpc]")
