...
namespace asp {
  ...
  // GroundToCameraTransform can cache itself.
  ...
  public:
    ...
    Tx2T tx2; // public so that we can invoke caching manually for GroundToCameraTransform
  ...
  public:
    ...
    // map projection.
    typedef CompositionTransformPassBBox<vw::cartography::GroundToCameraTransform2,vw::HomographyTransform> left_tx_type;
    typedef CompositionTransformPassBBox<vw::cartography::GroundToCameraTransform2,vw::HomographyTransform> right_tx_type;
